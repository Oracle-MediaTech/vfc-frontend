...
const blank: ServiceTemplateInput = {
   order: 1,
   serviceTime: "",
   preServiceTime: "",
   closesAt: "",
                  ...
                  <>
                     <div className="flex items-center justify-between">
                        <p className="text-sm text-gray-500">
                           Pick a variation at session-start time when the
                           day&apos;s services differ from the default.
                        </p>
                     ...
                     {loading ? (
                        ...
                        <p className="text-sm text-gray-500 py-4 text-center">
                           No variations yet. The default services on this day
                           will always be used.
                        </p>
                     ) : (
                  ...
                  <div className="space-y-4 border rounded-lg p-3">
                     ...
                     <div className="space-y-2">
                        ...
                        <TemplateServicesEditor
                           ...
                           onChange={(next) =>
                              setEditor({ ...editor, services: next })
                           }
                        />
                     </div>
