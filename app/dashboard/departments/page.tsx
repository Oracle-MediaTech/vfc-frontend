      ...
      <div className="space-y-6">
         <div>
            ...
            <p className="text-gray-500">
               Every department you belong to. Open one to access tools your
               role unlocks.
            </p>
         </div>
         ...
         {entries.length === 0 ? (
            <Card>
               <CardContent className="py-10 text-center text-sm text-gray-500">
                  You haven&apos;t been assigned to a department yet. Ask an
                  admin to add you.
               </CardContent>
            </Card>
         ) : (
               ...
               {entries.map((e) => (
                  <Card key={e.dept.id}>
                     ...
                     <CardContent className="space-y-3">
                        ...
                        <Link
                           href={`/dashboard/departments/view?id=${e.dept.id}`}
                        >
