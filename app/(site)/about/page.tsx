               ...
               <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                  <div className="relative p-10 rounded-2xl bg-primary/5 border border-primary/10">
                     ...
                     <p className="text-muted-foreground leading-relaxed text-lg">
                        To be a beacon of hope and transformation in Amassoma
                        and beyond, leading people to Christ and empowering them
                        to live purposeful lives through the Word of God.
                     </p>
                  </div>
                  ...
                  <div className="relative p-10 rounded-2xl bg-gold/5 border border-gold/10">
                     ...
                     <p className="text-muted-foreground leading-relaxed text-lg">
                        ...
                        experience His love, and be equipped to serve Him and
                        others effectively in every area of life.
                     </p>
                  </div>
               </div>
            </div>
               ...
               <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                  <div>
                     ...
                     <div className="space-y-4 text-muted-foreground leading-relaxed">
                        <p>
                           Vision Family Church was founded in 2014 with a
                           simple yet powerful calling: to bring the light of
                           God&apos;s Word to the community of Amassoma and the
                           entire Bayelsa State.
                        </p>
                        <p>
                           What began as a small gathering of faithful believers
                           has grown into a vibrant community of worshippers,
                           united by their love for God and passion for
                           impacting lives.
                        </p>
                        <p>
                           Today, we continue to grow in numbers and in grace,
                           reaching out to the lost, nurturing believers, and
