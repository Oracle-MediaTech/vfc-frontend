            ...
            <div className="relative h-full flex items-center justify-center text-center text-white px-4">
               <div className="max-w-4xl">
                  ...
                  <h1 className="text-5xl md:text-7xl font-bold mb-6 animate-fade-up leading-tight">
                     A Place of <span className="text-gold">Divine Vision</span>
                     <br />
                     and Purpose
                  </h1>

                  <p className="text-lg md:text-xl text-white/80 mb-10 max-w-2xl mx-auto animate-fade-up animation-delay-200">
                     Experience the transforming power of God&apos;s love in a
                     vibrant community of faith, hope, and purpose.
                  </p>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
               ...
               <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                  {features.map((feature, index) => (
                     <div
                        key={index}
                        className="group text-center p-8 rounded-2xl bg-white border-2 border-border card-hover"
                     >
               ...
               <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                  <div>
                     ...
                     <p className="text-muted-foreground mb-10 leading-relaxed">
                        We would love to have you worship with us. Our services
                        are designed to uplift, inspire, and draw you closer to
                        God. Come as you are.
                     </p>
         ...
         <section className="relative py-24 overflow-hidden">
            ...
            <div className="relative max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
               ...
               <p className="text-lg text-white/80 mb-10 max-w-xl mx-auto">
                  ...
                  we welcome you with open arms. Come experience God&apos;s love
                  with us.
               </p>
