...
const Navbar = () => {
   ...
   return (
      <>
         <nav className="fixed w-full z-50 transition-all duration-500 glass shadow-lg shadow-black/5">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
               <div className="flex items-center justify-between h-20">
                  <Link href="/" className="flex items-center gap-2.5 group">
                     <div className="p-2 rounded-lg transition-colors duration-300 bg-primary/10">
                        <Church className="h-6 w-6 transition-colors duration-300 text-primary" />
                     </div>
                  ...
                  <div className="flex items-center gap-3">
                     ...
                     <Button
                        variant="ghost"
                        size="icon"
                        className="lg:hidden rounded-lg text-black hover:text-black/80 hover:bg-black/10"
