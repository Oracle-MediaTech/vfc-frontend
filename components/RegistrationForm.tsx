...
// ✅ Schema matching exact backend enum strings
const formSchema = z.object({
  firstName: z.string().min(2, "First name must be at least 2 characters"),
  lastName: z.string().min(2, "Last name must be at least 2 characters"),
  email: z.string().email("Invalid email address"),
  ...
  address: z.string().min(5, "Please enter your address"),
  gender: z.string().min(1, "Please select your gender"),
  membershipType: z.enum(["NON_WORKER", "WORKER"], {
    required_error: "Please select membership type",
  }),
  churchStatus: z.enum(["FIRST_TIMER", "VISITOR", "MEMBER"], {
    required_error: "Please select your church status",
  }),
});
